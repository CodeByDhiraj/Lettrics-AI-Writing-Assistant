      ...
      <header className="relative z-10 flex items-center justify-between p-6 pt-12">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Paragraph Complete</h1>
              <p className="text-sm text-gray-400">Your AI-generated paragraph is ready</p>
            </div>
          </div>
        </div>
            ...
            {isEditing ? (
              <div className="space-y-6">
                <Textarea
                  ...
                  className="min-h-[400px] bg-gray-700/50 border border-gray-600/50 text-white rounded-2xl resize-none focus:ring-2 focus:ring-purple-500/50 font-serif text-lg leading-relaxed p-6"
                />
                <div className="flex gap-3">
                  <Button

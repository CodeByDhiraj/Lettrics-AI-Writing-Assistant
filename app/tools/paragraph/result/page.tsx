...
export default function ParagraphResultPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-violet-950 to-indigo-950 text-white">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-purple-500/10 to-violet-500/10 rounded-full blur-3xl animate-pulse" />
      ...
      <header className="relative z-10 flex items-center justify-between p-6 pt-12">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Paragraph Ready</h1>
              <p className="text-sm text-gray-400">Your AI-generated paragraph is below</p>
            </div>
          </div>
        </div>
      ...
      <div className="relative z-10 px-4 sm:px-6 pb-20">
          ...
          <Card className="p-6 sm:p-8 bg-gray-800/30 backdrop-blur-xl border border-gray-700/50 shadow-2xl rounded-3xl w-full max-w-5xl mx-auto">
            ...
            {isEditing ? (
              <Textarea
                ...
                className="min-h-[60vh] h-[70vh] bg-gray-700/50 border border-gray-600/50 text-white rounded-2xl resize-none focus:ring-2 focus:ring-purple-500/50 font-serif text-lg leading-relaxed p-6"
              />
            ) : (
        ...
        >
          <Link href="/tools/paragraph">
            <Button className="bg-gradient-to-r from-purple-500 to-violet-500 hover:from-purple-600 hover:to-violet-600 text-white rounded-2xl px-8 py-3 font-medium">

    ...
    <div className="relative">
      ...
      <div className="relative">
        <button
          ...
          className="w-full bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl px-6 py-4 text-left text-white hover:bg-gray-700/50 transition-all duration-200 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50"
        >
  ...
  const handleGenerate = async () => {
    if (!topic.trim()) {
      toast({
        ...
        description: "Please enter a topic for your paragraph.",
        variant: "destructive",
      })
      return
    }
    ...
    router.push("/tools/paragraph/loading")
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
      ...
      <header className="relative z-10 flex items-center gap-4 p-6 pt-12">
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <div className="w-14 h-14 bg-gradient-to-br from-purple-500 via-violet-500 to-indigo-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-purple-500/25">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">Paragraph Writer</h1>
            <p className="text-sm text-gray-400">AI-powered paragraph generation</p>
          </div>
        </div>
      </header>
          ...
          <Card className="p-8 mb-8 bg-gray-800/30 backdrop-blur-xl border border-gray-700/50 shadow-2xl rounded-3xl">
            <div className="space-y-8">
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl px-6 py-4 text-white placeholder:text-gray-400 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 text-lg"
                  />
                  <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
              ...
              <Button
                ...
                disabled={!topic.trim()}
                className="w-full py-6 rounded-2xl bg-gradient-to-r from-purple-500 via-violet-500 to-indigo-500 hover:from-purple-600 hover:via-violet-600 hover:to-indigo-600 text-white font-semibold text-lg shadow-2xl shadow-purple-500/25 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
              >

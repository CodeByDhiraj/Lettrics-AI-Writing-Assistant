...
import { ArrowLeft, Copy, RotateCcw, Edit, Check, BookOpen, Sparkles, Home } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
      ...
      <header className="relative z-10 flex items-center justify-between p-6 pt-12">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Story Complete</h1>
              <p className="text-sm text-gray-400">Your AI-generated story is ready</p>
            </div>
          </div>
        </div>
      ...
      <div className="relative z-10 px-6 pb-24">
            ...
            {isEditing ? (
              <div className="space-y-6">
                <Textarea
                  ...
                  className="min-h-[400px] bg-gray-700/50 border border-gray-600/50 text-white rounded-2xl resize-none focus:ring-2 focus:ring-blue-500/50 font-serif text-lg leading-relaxed p-6"
                />
                <div className="flex gap-3">
                  <Button
        ...
        >
          <Link href="/tools/story">
            <Button className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white rounded-2xl px-8 py-3 font-medium">
              Write Another Story
            </Button>
          </Link>
          <Link href="/">

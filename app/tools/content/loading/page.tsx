...
const loadingMessages = {
  short: [
    "Lettrics is generating your content...",
    "Outlining catchy phrases...",
    "Finalizing tone and audience...",
    "Almost ready...",
  ],
  medium: [
    "Lettrics is generating your content...",
    "Structuring content layout...",
    "Optimizing for tone and length...",
    "Refining for audience impact...",
    "Final touches in progress...",
    "Almost ready...",
  ],
  long: [
    "Lettrics is preparing your detailed content...",
    "Researching and expanding ideas...",
    "Tailoring paragraphs for engagement...",
    "Applying tone and contextual flow...",
    "Enriching content for maximum impact...",
    "Wrapping up your long-form content...",
    "Almost done writing...",
  ],
}
...
export default function ContentLoadingPage() {
  ...
  useEffect(() => {
    ...
    const generateContent = async () => {
      try {
        const response = await fetch("/api/gen_con", {
          method: "POST",
          headers: {
        ...
        if (result.success) {
          ...
          setTimeout(() => {
            clearInterval(messageInterval)
            router.push("/tools/content/result")
          }, 2000)
        } else {
        ...
        clearInterval(messageInterval)
        router.push("/tools/content?error=generation_failed")
      }
    }
      ...
      <div className="relative z-10 text-center px-6">
        ...
        >
          <div className="relative inline-block">
            <motion.div
              ...
              className="w-24 h-24 bg-gradient-to-br from-yellow-500 via-orange-500 to-red-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-orange-500/25 mx-auto"
            >
        ...
        >
          ...
          <p className="text-gray-400 text-lg">
            Creating your {formData.type?.toLowerCase() || "custom"} content...
          </p>
        </motion.div>
